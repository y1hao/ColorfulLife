  ...
  >
    <List>
      <ListItem>
        <div className={classes.listItem}>
          ...
          <Typography variant="h4" className={classes.centered}>
            {props.name}&nbsp;<CreateSharp fontSize="small" onClick={() => setIsNameDialogOpen(true)} />
          </Typography>
          {
            inputDialog(
              isNameDialogOpen,
      ...
      <ListItem>
        <div className={classes.listItem}>
          ...
          <Typography variant="body1" className={classes.centered}>
            {props.author}&nbsp;<CreateSharp fontSize="inherit" onClick={() => setIsAuthorDialogOpen(true)} />
          </Typography>
          {
            inputDialog(
              isAuthorDialogOpen,
      ...
      <ListItem>
        <div className={classes.listItem}>
          ...
          <Typography variant="body1" className={classes.centered}>
            {props.description}&nbsp;<CreateSharp fontSize="inherit" onClick={() => setIsDescriptionDialogOpen(true)} />
          </Typography>
          {
            inputDialog(
    ...
    <List>
      ...
      <ListItem>
        ...
        >
          Read from file
          <input type="file" accept="application/json" style={{ display: "none" }} onChange={handleReadFromFile} />
        </Button>
      </ListItem>
      <ListItem>
        <Button
